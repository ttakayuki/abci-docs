...
利用を開始するには、各ABCIグループの利用管理者からの申請が必要です。[ABCI利用者ポータル](https://portal.v3.abci.ai/user/)から申請を行ってください。利用管理者でない場合は、所属グループの利用管理者にお問い合わせください。ABCI利用者ポータルの操作方法に関しては、[ABCI利用者ポータルガイド](https://docs.abci.ai/v3/portal/ja/)をご参照ください。
...
| ページ名 | 概要 |
|:--|:--|
| [クラウドストレージアカウントディレクトリとアクセスキー](abci-cloudstorage/cs-account.md) | クラウドストレージで用いるアカウントと認証用のアクセスキーについて説明しています。 |
